         ...
         bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"
			...
			<div className="flex justify-center relative my-20 z-10">
				<div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
					<p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-80">Full Stack Developer & AI Enthusiast</p>
					 ...
					 */}
					<TextGenerateEffect
						words="Building Scalable Web Applications with Modern Technologies"
						className="text-center text-[32px] md:text-[40px] md:text-5xl lg:text-6xl"
					/>

					<p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
						Hi! I&apos;m Aryan Gaikwad, a Full Stack Developer based in Mumbai, India.
					</p>
